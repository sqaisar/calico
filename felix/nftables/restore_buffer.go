...
// RestoreInputBuilder builds a byte slice for use as input to nft
//
...
// WriteLine writes a line of instructions to the buffer.  Intended for writing the actual rules.
// Panics if there is no open transaction.
